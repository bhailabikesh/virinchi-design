...
<body>
  ...
  <main>
            ...
            <div class="program__info">
              <div class="program__info--wp">
                ...
                <div class="program__info--description">
                  <p>
                    Get Ready For Better Future Smart - Perhaps a Cliche
                    Today, but for us it's the goal - to make our students
                    smart to create an accomplished life.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="card border-0 program__card">
                  <img src="assets/img/program-1.png" alt="program" class="card-img img-fluid" />
                  <div class="card-body">
                    <div class="program__card--duration">
                      <h6>4 Year Program</h6>
                    </div>
              ...
              <div class="col-sm-6">
                <div class="card border-0 program__card">
                  <img src="assets/img/program-2.png" alt="program" class="card-img img-fluid" />
                  <div class="card-body">
                    <div class="program__card--duration">
                      <h6>2 Year Program</h6>
                    </div>
                    <div class="program__card--name" data-mh="programTitle">
    ...
    <section class="quick-action">
      ...
      <div class="quick-action__bg"></div>
    </section>
    <!-- Quick Action End -->
  </main>
