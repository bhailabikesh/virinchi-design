...
<head>
    ...
    <title>Request Info - Virinchi College – Smart By Intellect</title>
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select name="" id="" class="form-control fm-default">
                                    <option value="">-- Select One --</option>
                                    <option value="">I am currently in high school</option>
                                    <option value="">I am in Grade 10</option>
                                    <option value="">I am in Grade 11</option>
                                    <option value="">I am in Grade 12</option>
                                    <option value="">I have completed bachelor’s degree</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                                <label for="place" class="bold-label">QUESTION<strong>*</strong></label>
